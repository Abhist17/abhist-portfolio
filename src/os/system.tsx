...
export type AppId =
  | "about" | "projects" | "background" | "stack" | "contact" | "terminal" | "photo";
...
export type AppMeta = {
  ...
  kind: "folder" | "doc" | "terminal" | "mail" | "grid" | "photo";
  w: number;
  h: number;
  /* desktop icon slot */
  slot: number;
...
export const APPS: AppMeta[] = [
  ...
  { id: "photo",      name: "Me.jpg",     kind: "photo",    w: 460, h: 560, slot: 6, onDesktop: true,  inDock: false },
];
